...
pub struct AccountConnectionDetail {
    ...
    #[serde(rename = "name")]
    pub name: String,
    /// Identifies the warehouse and version of its adapter
    #[serde(rename = "adapter_version")]
    pub adapter_version: models::DbtAdapterVersion,
    #[serde(
        rename = "private_link_endpoint_id",
        skip_serializing_if = "Option::is_none"
    )]
    pub private_link_endpoint_id: Option<String>,
    #[serde(
        rename = "is_ssh_tunnel_enabled",
        skip_serializing_if = "Option::is_none"
    )]
    pub is_ssh_tunnel_enabled: Option<bool>,
    /// If OAuth is enabled for this connection, this field is used internally by dbt Cloud
    #[serde(rename = "oauth_redirect_uri")]
    ...
    pub is_configured_for_native_oauth: Option<bool>,
    #[serde(
...
impl AccountConnectionDetail {
    pub fn new(
        ...
        AccountConnectionDetail {
            ...
            name,
            adapter_version,
            private_link_endpoint_id: None,
            is_ssh_tunnel_enabled: None,
            oauth_redirect_uri,
            oauth_configuration_id: None,
            is_configured_for_native_oauth: None,
            platform_metadata_credentials_id: None,
