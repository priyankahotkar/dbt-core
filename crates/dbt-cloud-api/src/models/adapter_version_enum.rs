...
pub enum AdapterVersionEnum {
    ...
    DatabricksSparkV0,
    #[serde(rename = "databricks_v0")]
    DatabricksV0,
    #[serde(rename = "trino_v0")]
    TrinoV0,
    #[serde(rename = "snowflake_v0")]
    SnowflakeV0,
    #[serde(rename = "bigquery_v0")]
    BigqueryV0,
    #[serde(rename = "bigquery_v1")]
    BigqueryV1,
    #[serde(rename = "postgres_v0")]
    PostgresV0,
    #[serde(rename = "redshift_v0")]
    RedshiftV0,
    #[serde(rename = "synapse_v0")]
    SynapseV0,
    #[serde(rename = "fabric_v0")]
    FabricV0,
    #[serde(rename = "athena_v0")]
    AthenaV0,
    #[serde(rename = "teradata_v0")]
    TeradataV0,
}

impl std::fmt::Display for AdapterVersionEnum {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            Self::ApacheSparkV0 => write!(f, "apache_spark_v0"),
            Self::DatabricksSparkV0 => write!(f, "databricks_spark_v0"),
            Self::DatabricksV0 => write!(f, "databricks_v0"),
            Self::TrinoV0 => write!(f, "trino_v0"),
            Self::SnowflakeV0 => write!(f, "snowflake_v0"),
            Self::BigqueryV0 => write!(f, "bigquery_v0"),
            Self::BigqueryV1 => write!(f, "bigquery_v1"),
            Self::PostgresV0 => write!(f, "postgres_v0"),
            Self::RedshiftV0 => write!(f, "redshift_v0"),
            Self::SynapseV0 => write!(f, "synapse_v0"),
            Self::FabricV0 => write!(f, "fabric_v0"),
