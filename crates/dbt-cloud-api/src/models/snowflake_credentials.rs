...
pub struct SnowflakeCredentials {
    ...
    pub auth_type: models::SnowflakeCredentialsAuthTypeEnum,
    #[serde(rename = "schema")]
    pub schema: String,
    ...
    #[serde(rename = "_refresh_token", skip_serializing_if = "Option::is_none")]
...
impl SnowflakeCredentials {
    pub fn new(
        ...
        state: i32,
        threads: i32,
        auth_type: models::SnowflakeCredentialsAuthTypeEnum,
        schema: String,
        target_name: String,
