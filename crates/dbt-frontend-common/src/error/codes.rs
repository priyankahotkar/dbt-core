...
pub enum ErrorCode {
    ...
    TrailingWhitespace = 131,
    LineTooLong = 132,
    PreferCoalesce = 133,
    TableAliasStyle = 134,
    IdentifierTooShort = 135,
    ColumnAliasStyle = 136,
    CastingStyleMismatch = 137,
    AmbiguousUnion = 138,
    SelectTargetsNotOnNewLines = 139,
    RightJoinUsed = 140,
    DuplicateTableAlias = 141,
    UnusedTableAlias = 142,
    FunctionSpaceBeforeParen = 143,
    SetOperatorNotOnOwnLine = 144,
    SpaceInsideBrackets = 145,
    AmbiguousOrderByDirection = 146,
    JoinUsingSyntax = 147,
    CountRowsNotStar = 148,
    JoinWithoutCondition = 149,
    SelectTrailingComma = 150,
    DuplicateColumnAlias = 151,
    EndOfFileMissingNewline = 152,
    StartOfFileWhitespace = 153,
    CaseShouldUseSimpleForm = 154,
    SelectModifierOnNewLine = 155,
    TabIndentation = 156,
    OperatorSpacingError = 157,
    SelfComparison = 158,
    SelfAlias = 159,
    DerivedTableMissingAlias = 160,
    TooManyEmptyLines = 161,
    CteBlankLine = 162,
    AliasForbidden = 163,
    SelectStarUnknownColumns = 164,
    UnionColumnCountMismatch = 165,
    AliasLengthViolation = 166,
    IdentifierCaseMismatch = 167,
    KeywordLinePosition = 168,
    OracleEmptyBatch = 169,
    ReferenceNotQualified = 170,
    UnusedJoin = 171,
    ConsecutiveSemicolons = 172,
